                            ...
                            if (xhttp.status === 200) { // successfully
                                ...
                                if (obj.verified) {
                                    ...
                                    web3.eth.getGasPrice().then((gasPrice) => {
                                        ...
                                        multisig.methods.verifyTransaction(addrFrom, recipientAddress, amountToTransfer, obj.signature).estimateGas({gas: gasPrice, from: addrFrom}, function(error, gasAmount) {
                                            if (error) {
                                                console.log(error);
                                            ...
                                            const txObject = {
                                                ...
                                                to: multisigAddress,
                                                data: multisig.methods.verifyTransaction(addrFrom, recipientAddress, amountToTransfer, obj.signature).encodeABI()
                                            };

...
const recoverFundsToSafeAddress = (ownerPublic, recipientAddress, amountToTransfer, privateKey,
    ...
    web3.eth.getTransactionCount(address, (err, txCount) => {
        ...
        web3.eth.getGasPrice().then((gasPrice) => {
            ...
            multisig.methods.recoverFundsToSafeAddress(ownerPublic, recipientAddress, amountToTransfer).estimateGas({gas: gasPrice, from: address}, function(error, gasAmount) {
...
export default recoverFundsToSafeAddress;
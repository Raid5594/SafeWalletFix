...
const depositEther = (amountToDeposit, privateKey, web3, multisig, multisigAddress, modal, updateBalances, address) => {
    ...
    web3.eth.getTransactionCount(address, (err, txCount) => {
      // Build the transaction
        web3.eth.getGasPrice().then((gasPrice) => {
            multisig.methods.deposit_CIx().estimateGas({gas: gasPrice, from: address, value: amountToDeposit}, function(error, gasAmount) {

...
import { setWeb3, setMultisig, setMultisigAddress, setMultisigERC, 
	...
	updateTokenImperialContractBalance, updateTokenDemocraticContractBalance, 
	setUpdateBalancesEther, setUpdateBalancesERC, setMultisigERC20Address } from '../../stateManagement/actions';
...
class BlockchainData extends Component {
	...
	onHandleClick = (e) => {
		...
		if (this.state.Ethereum === true) {
			...
			this.props.history.push('/Blockchain/ERC20');
			}
			break;   
			default:
			break;
	...
	render() {
		return (
			<div id="content" className ="smart">
				...
				{
				this.state.Ethereum ? 
				<Route path = '/Blockchain/Ether/' component={SmartContract} />
				:
				<Route path = '/Blockchain/ERC20/' component={ERC20} />
				}
			</div>  
		);
  }
...
export default withRouter(connect(mapStateToProps, { setWeb3, setMultisig, setMultisigAddress, setMultisigERC, 
	setTokenImperial, setTokenDemocratic, updateEtherBalance, 
	updateContractBalance, updateTokenImperialBalance, updateTokenDemocraticBalance,

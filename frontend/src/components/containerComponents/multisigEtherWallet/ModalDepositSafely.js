...
import { depositEtherSafely } from '../../../utils';
...
class ModalDepositSafety extends React.Component {
    ...
    deposit = (amountToDeposit, safetyPubKey, privateKey) => {
        ...
        depositEtherSafely(amountToDeposit, safetyPubKey, privateKey, web3, multisig, multisigAddress, modal, updateBalances, address);
    } 
